...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-11">
            ...
            <?= form_open_multipart('distributor/metodepembayaran'); ?>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <?php foreach ($metodeuser as $r) : ?>
                                                            <tr>
                                                                ...
                                                                <a href="<?= base_url('distributor/deletemetode/') . $r['id']; ?> " class="badge badge-danger">Delete</a>
                                                            </td>
                                                            </tr>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="<?= base_url('distributor/updatemetode/') . $r['id']; ?>" method="post">
