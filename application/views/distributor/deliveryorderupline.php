          ...
          <thead class="thead-dark">
                ...
                <tbody>
                    ...
                    <td><?= $r['total_product'];  ?></td>
                        ...
                        <a id="tombolselesai" nama="tombolselesai" href="<?= base_url('distributor/selesaikandeliveryorder/') . $r['nomordo']; ?>"  class="badge badge-primary">Selesaikan DO</a>
                            <?php } ?>  
                        </td>
                    </tr>
        ...
        <div class="modal-content">
            ...
            <form action="<?= base_url('admin/menuparfumupdate/') . $r['id']; ?>" method="post">
                ...
                <div class="form-group" >
                    ...
                    <a href="<?= base_url('distributor/deliveryorderuplinedetail/') . $r['nomordo']; ?> " class="badge badge-info">Lihat Detail</a>
        </form>
