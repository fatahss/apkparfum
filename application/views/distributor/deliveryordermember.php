                ...
                <tbody>
                    ...
                    <td><?= $r['nama_receiver'];  ?></td>
                        ...
                        <?php if($r['status'] == 'Sedang dalam Pengiriman'){ ?>
                            ...
                            <a href="<?= base_url('distributor/deletedomember/') . $r['nomordo']; ?> " class="badge badge-danger">Delete</a>
                            <?php } ?>  
        ...
        <div class="modal-content">
            ...
            <form action="<?= base_url('admin/menuparfumupdate/') . $r['id']; ?>" method="post">
                ...
                <div class="form-group" >
                    ...
                    <a href="<?= base_url('distributor/deliveryordermemberdetail/') . $r['nomordo']; ?> " class="badge badge-info">Lihat Detail</a>
        </form>
