...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-8">
            ...
            <?= form_open_multipart('distributor/addcart'); ?>
...
;" >
        ...
        <!--<button type="button" class="btn-warning" onclick="addData(this)">Add</button>-->
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="<?= base_url('distributor/deletecart/') . $r['id']; ?> " class="badge badge-danger">Delete</a>
                        </td>
                    </tr>
                    <?php $i++; ?>
                    <?php endforeach; ?>
            ...
            <div class="row-sm-10">
            <h4><a href="<?= base_url('distributor/ajukanpo')?> " class="badge badge-primary ">Ajukan</a></h4>
            
            <h4><a href="<?= base_url('distributor/cartreset')?> " class="badge badge-danger ">Reset</a></h4>
            </div>
