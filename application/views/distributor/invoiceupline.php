                ...
                <tbody>
                    ...
                    <?php foreach ($invoiceuser as $r) : ?>
                        <tr>
                            ...
                            <a href="<?= base_url('distributor/pembayaran/') . $r['nomorinvoice']; ?> " class="badge badge-primary">Bayar</a>
                            <?php } ?>  
                                    ...
                                    <form action="<?= base_url('admin/menuparfumupdate/') . $r['id']; ?>" method="post">
                                        ...
                                        <div class="modal-body">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control bg-dark text-gray-100" id="nomorpo" name="nomorpo" placeholder="Nomor Invoice" value="<?= $r['nomorinvoice']; ?>" readonly>
                                            </div>
                                            <div class="form-group">
                                                <label for="name">Nomor Preorder:</label>
                                                <input type="text" class="form-control bg-dark text-gray-100" id="nomorpo" name="nomorpo" placeholder="Nomor Preorder" value="<?= $r['nomorpo']; ?>" readonly>
                                            </div>
                                            <div class="form-group">
                                                <label for="name">Nomor Delivery Order:</label>
                                                <input type="text" class="form-control bg-dark text-gray-100" id="nomorpo" name="nomorpo" placeholder="Nomor Delivery Order" value="<?= $r['nomordo']; ?>" readonly>
                                            </div>
                                            <div class="form-group" >
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control bg-dark text-gray-100" id="nama_upline" name="nama_upline" placeholder="Nama Upline" value="<?= $r['nama_requester']; ?>" readonly>
                                            </div>
                                            <!--<div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control bg-dark text-gray-100" id="created_at" name="created_at" placeholder="Status" value="<?= $r['status'];  ?>" readonly>
                                            </div>
