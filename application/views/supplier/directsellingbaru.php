...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-8">
            ...
            <?= form_open_multipart('supplier/addcart2'); ?>
...
;" >
                            ...
                            <option value="<?= $m['nama_parfum']."|".$m['harga_supplier']."|".$m['id'] ?>" data-harga="<?= $m['harga_supplier']; ?>"><?= $m['nama_parfum'],'; Harga : Rp. ',number_format($m['harga_supplier'],0,',',',')?></option>
                            <?php endforeach; ?>
                        </select>
                        </div>
                    </div>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="<?= base_url('supplier/deletecart2/') . $r['id']; ?> " class="badge badge-danger">Delete</a>
                        </td>
                    </tr>
                    <?php $i++; ?>
                    <?php endforeach; ?>
        ...
        <h4><a href="<?= base_url('supplier/cartreset2')?> " class="badge badge-danger ">Reset</a></h4>

        <?= form_open_multipart('supplier/tambahdirectselling'); ?>
        ...
        <div class="form-group row">
            ...
            <div class="row-sm-10">
            <!--<h4><a href="<?= base_url('supplier/tambahdirectselling')?> " class="badge badge-primary ">Ajukan</a></h4>
                    -->
