                ...
                <tbody>
                    ...
                    <td><?= $r['nama_receiver'];  ?></td>
                        ...
                        <?php if($r['status'] == 'Sedang dalam Pengiriman'){ ?>
                            ...
                            <a href="<?= base_url('supplier/deletedomember/') . $r['nomordo']; ?> " class="badge badge-danger">Delete</a>
                            <?php } ?>  
        ...
        <div class="modal-content">
            ...
            <form action="<?= base_url('admin/menuparfumupdate/') . $r['id']; ?>" method="post">
                ...
                <div class="form-group" >
                    ...
                    <div class="form-group">
                        <label for="name" class="text-gray-900">Nama Member:</label>
                    ...
                    <a href="<?= base_url('supplier/deliveryordermemberdetail/') . $r['nomordo']; ?> " class="badge badge-info">Lihat Detail</a>
        </form>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <form action="<?= base_url('supplier/pengajuandeliveryorder/') . $r['nomorpo']; ?>" method="post">
                <div class="modal-body">
                <div class="form-group" >
