...
<div class="container-fluid">
    ...
    <div class="form-group" >
        <a href="<?= base_url('supplier/pengajuanpreorder'); ?>" class="btn btn-primary mb-3" >Ajukan PO Baru</a>
        </div>
                ...
                <tbody>
                    ...
                    <td><a data-toggle="modal" data-target="#detailPoModal<?php echo $r['nomorpo']; ?>"  href="#" class="btn text-info font-weight-bold "><?= $r['nomorpo']; ?></a></td>
                        ...
                        <?php if($r['status'] == 'Belum di Proses'){ ?>
                           ...
                           <a href="<?= base_url('supplier/deletepoupline/') . $r['nomorpo']; ?> " class="badge badge-danger">Delete</a>
                       <?php } ?> 
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <div class="modal-body">
                    ...
                    <a href="<?= base_url('supplier/preorderuplinedetail/') . $r['nomorpo']; ?> " class="badge badge-info">Lihat Detail</a>
