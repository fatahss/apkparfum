          ...
          <thead class="thead-dark">
                ...
                <tbody>
                    ...
                    <td><?= $r['total_product'];  ?></td>  
                        ...
                        <a id="tombolselesai" nama="tombolselesai" href="<?= base_url('reseller/selesaikandeliveryorder/') . $r['nomordo']; ?>"  class="badge badge-primary">Selesaikan DO</a>
                            <?php } ?>  
                        </td>
                    </tr>
            ...
            <form action="<?= base_url('admin/menuparfumupdate/') . $r['id']; ?>" method="post">
                ...
                <div class="form-group" >
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="name">Total Harga Produk:</label>
                    ...
                    <div class="form-group">
                        <label for="name" class="text-gray-900">Upline:</label>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control bg-dark text-gray-100" id="hargapaket" name="hargapaket" placeholder="" value="Rp. <?= number_format($r['hargapaket'],0,',',',')?>"readonly>
                    </div>

                    <div class="form-group">
                        <label for="name">Note:</label>
                        <input type="text" class="form-control bg-dark text-gray-100" id="note" name="note" placeholder="" value="<?= $r['note']; ?>"readonly>
                    </div>
                    <div class="form-group">
                        <label for="name" class="text-gray-900">Status:</label>
                        <input type="text" class="form-control bg-dark text-gray-100" id="nama_upline" name="nama_upline" placeholder="Status" value="<?= $r['status']; ?>"readonly>
                    </div>
                    <div class="form-group">
                        <label for="ijazah" class="text-gray-900">Tanggal:</label>
                    ...
                    <a href="<?= base_url('reseller/deliveryorderdetail/') . $r['nomordo']; ?> " class="badge badge-info">Lihat Detail</a>
