...
<div class="container-fluid">
    ...
    <div class="form-group">
        <a href="<?= base_url('reseller/pengajuanpreorder'); ?>" class="btn btn-primary mb-3">Ajukan PO Baru</a>
    </div>
                ...
                <tbody>
                    ...
                    <td><a data-toggle="modal" data-target="#poitemModal<?php echo $r['nomorpo']; ?>" href="#" class="btn text-info font-weight-bold "><?= $r['total_product']; ?></td>
                            ...
                            <?php if($r['status'] == 'Belum di Proses'){ ?>
                                ...
                                <a href="<?= base_url('reseller/preorderedit/') . $r['nomorpo']; ?> " class="badge badge-info">Edit</a>

                                <a href="<?= base_url('reseller/deletepo/') . $r['nomorpo']; ?> " class="badge badge-danger">Delete</a>
                                <?php } ?> 
