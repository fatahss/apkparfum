...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-8">
            ...
            <?= form_open_multipart('reseller/addcart2'); ?>
...
;" >
                            ...
                            <option value="<?= $m['nama_parfum']."|".$m['harga_reseller'] ?>" data-harga="<?= $m['harga_reseller']; ?>"><?= $m['nama_parfum'],'; Harga : Rp. ',number_format($m['harga_reseller'],0,',',',') ?></option>
                            <?php endforeach; ?>
                        </select>
                        </div>
                    </div>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="<?= base_url('reseller/deletecart2/') . $r['id']; ?> " class="badge badge-danger">Delete</a>
                        </td>
                    </tr>
                    <?php $i++; ?>
                    <?php endforeach; ?>
        ...
        <h4><a href="<?= base_url('reseller/cartreset2')?> " class="badge badge-danger ">Reset</a></h4>

        <?= form_open_multipart('reseller/tambahdirectselling'); ?>
        ...
        <div class="form-group row">
            ...
            <div class="row-sm-10">
            <!--<h4><a href="<?= base_url('reseller/tambahdirectselling')?> " class="badge badge-primary ">Ajukan</a></h4>
                    -->
