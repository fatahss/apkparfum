           ...
           <div class="input-group">
            ...
            <button type="button" class="btn btn-primary">
              <i class="fas fa-search"></i>
                            ...
                            <input type="text" class="form-control bg-dark text-gray-100" id="nomorpo" name="nomorpo" placeholder="Nomor PO" value="<?= $directsellinguser['nomorpo']; ?>" readonly>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control bg-dark text-gray-100" id="nama_upline" name="nama_upline" placeholder="Nama Upline" value="<?= $directsellinguser['nama_upline']; ?>" readonly>
                        </div>
                        <div class="form-group">
                            <label for="ijazah">Tanggal:</label>
                            <input type="text" class="form-control bg-dark text-gray-100" id="created_at" name="created_at" placeholder="Created at" value="<?= date('d F Y (H:i)', $directsellinguser['created_at']);  ?>" readonly>
                        </div>
                        <div class="form-group">
                            <label for="ijazah">Status:</label>
                            <input type="text" class="form-control bg-dark text-gray-100" id="created_at" name="created_at" placeholder="Status" value="<?= $directsellinguser['status'];  ?>" readonly>
                        </div>
