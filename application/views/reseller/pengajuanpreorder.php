...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-8">
            ...
            <?= form_open_multipart('reseller/addcart'); ?>
...
;" >
        ...
        <!--<button type="button" class="btn-warning" onclick="addData(this)">Add</button>-->
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="<?= base_url('reseller/deletecart/') . $r['id']; ?> " class="badge badge-danger">Delete</a>
                        </td>
                    </tr >
            ...
            <div class="row-sm-10">
            <h4><a href="<?= base_url('reseller/ajukanpo')?> " class="badge badge-primary ">Ajukan</a></h4>
            
            <h4><a href="<?= base_url('reseller/cartreset')?> " class="badge badge-danger ">Reset</a></h4>
            </div>
