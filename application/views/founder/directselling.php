...
<div class="container-fluid">
    ...
    <div class="form-group">
        <a href="<?= base_url('founder/directsellingbaru'); ?>" class="btn btn-primary mb-3">Tambah Direct Selling Baru</a>
    </div>
                                ...
                                <div class="modal-content">
                                    ...
                                    <form action="<?= base_url('admin/menuparfumupdate/') . $r['id']; ?>" method="post">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <a href="<?= base_url('founder/directsellingdetail/') . $r['no_direct_selling']; ?> " class="badge badge-info">Lihat Detail</a>
                                        </div>
