                    ...
                    <?php foreach ($userreseller as $r) : ?>
                        ...
                        Belum Aktif
                            ...
                            <?php if($r['is_active'] == '0'){ ?>
                                ...
                                <a href="<?= base_url('founder/useraktif/') . $r['id']; ?> " class="badge badge-info">Aktifkan</a>

                            <?php } ?> 

                                
                                <a href="<?= base_url('founder/userdelete/') . $r['id']; ?> " class="badge badge-danger">Delete</a>
                            </td>
                        </tr>
                         <!-- Modal -->
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="form-group">
                    ...
                    <a href="<?= base_url('founder/memberdetail/') . $r['id']; ?> " class="badge badge-info">Lihat Detail</a>
