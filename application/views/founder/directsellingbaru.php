...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-8">
            ...
            <?= form_open_multipart('founder/addcart2'); ?>
...
;" >
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="<?= base_url('founder/deletecart2/') . $r['id']; ?> " class="badge badge-danger">Delete</a>
                        </td>
                    </tr>
                    <?php $i++; ?>
                    <?php endforeach; ?>
        ...
        <h4><a href="<?= base_url('founder/cartreset2')?> " class="badge badge-danger ">Reset</a></h4>

        <?= form_open_multipart('founder/tambahdirectselling'); ?>
        ...
        <div class="form-group row">
            ...
            <div class="row-sm-10">
            <!--<h4><a href="<?= base_url('founder/tambahdirectselling')?> " class="badge badge-primary ">Ajukan</a></h4>
                    -->
