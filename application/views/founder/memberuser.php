    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="form-group">
                    ...
                    <a href="<?= base_url('founder/inventorymember/') . $r['id']; ?> " class="badge badge-info">Lihat Inventory</a>
                    <a href="<?= base_url('founder/directsellingmember/') . $r['id']; ?> " class="badge badge-warning">Lihat Direct Selling</a>
                    <a href="<?= base_url('founder/pendapatanmember/') . $r['id']; ?> " class="badge badge-primary">Lihat Pendapatan</a></br>
                    <a href="<?= base_url('founder/pengeluaranmember/') . $r['id']; ?> " class="badge badge-dark">Lihat Pengeluaran</a>
                    <a href="<?= base_url('founder/memberuser/') . $r['id']; ?> " class="badge badge-secondary">Lihat Member</a>
