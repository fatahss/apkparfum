        ...
        <div class="table-responsive text-nowrap">
           ...
           <div class="input-group">
            ...
            <div class="form-group">
                    ...
                    <a href="<?= base_url('founder/inventorymember/') . $member['id']; ?> " class="badge badge-info">Lihat Inventory</a>
                    <a href="<?= base_url('founder/directsellingmember/') . $member['id']; ?> " class="badge badge-warning">Lihat Direct Selling</a>
                    <a href="<?= base_url('founder/pendapatanmember/') . $member['id']; ?> " class="badge badge-primary">Lihat Pendapatan</a></br>
                    <a href="<?= base_url('founder/pengeluaranmember/') . $member['id']; ?> " class="badge badge-dark">Lihat Pengeluaran</a>
                    <a href="<?= base_url('founder/memberuser/') . $member['id']; ?> " class="badge badge-secondary">Lihat Member</a>
