            ...
            <button type="button" class="btn btn-primary">
              <i class="fas fa-search"></i>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control bg-dark text-gray-100"  id="nama_upline" name="nama_upline" placeholder="" value="Rp. <?= number_format($directsellinguser['hargapaket'],0,',',',')?>"readonly>
                    </div>
                    <div class="form-group">
