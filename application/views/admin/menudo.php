                ...
                <tbody>
                    ...
                    <td><?= $r['nama_receiver'];  ?></td>
                        ...
                        <td>
                            ...
                            <a href="<?= base_url('admin/deletedo/') . $r['nomordo']; ?> " class="badge badge-danger">Delete</a>
        ...
        <div class="modal-content">
            ...
            <form action="<?= base_url('admin/menuparfumupdate/') . $r['id']; ?>" method="post">
                ...
                <div class="form-group" >
                    ...
                    <a href="<?= base_url('admin/deliveryorderdetailuser/') . $r['nomordo']; ?> " class="badge badge-info">Lihat Detail</a>
        </form>
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <div class="form-group" >
                        ...
                        <input type="text" class="form-control bg-dark text-gray-400" id="nomorpo" name="nomordo" placeholder="Nomor DO" value="DO<?= date('Ymd' , $date); ?><?= $dobaru; ?>" readonly>
                    </div>
                    <div class="form-group" >
                        <label for="name">Nomor PO:</label>
                        <input type="text" class="form-control bg-dark text-gray-400" id="nomorpo" name="nomorpo" placeholder="Nomor PO" value="<?= $r['nomorpo']; ?>" readonly>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="name">Harga Paket:</label>
                        <input type="text" class="form-control" id="hargapaket" name="hargapaket" placeholder="Harga Paket" value="">
                    </div>
